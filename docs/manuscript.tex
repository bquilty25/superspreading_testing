...
contact survey, which may have truncated the contact distribution.}
...
course of the pandemic (Figure S4). Both the mean and \(k\) of
...
(Figure S1). Figure S5, in which contacts are stratified by age as well
...
al.~Figure S6 shows the difference in viral load trajectories and
...
still higher (Figure S7). The finding that contact heterogeneity plays a
...
without overdispersion in contacts (Figure S8), we can see that ignoring
...
deviation in viral load trajectory parameters (Figure S7); however,
...
from the CoMix contact survey relative to the mid-2020 UK age
distribution \citep{ons2022}.}
...
\caption{\label{fig-s4}Distribution of the number of reported daily
...
\caption{\label{fig-s5}Contact distributions by age and gender across
...
\caption{\label{fig-s6}Comparison of viral load trajectories and
infectivity for the sensitivity analysis with double the standard
...
\caption{\label{fig-s7}Sensitivity of estimates of dispersion of the
...
\caption{\label{fig-s8}Comparison of the impact of regular lateral flow
testing on \(R\), \(k\), and the proportion infecting over 10 or 0
